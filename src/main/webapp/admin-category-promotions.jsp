...
<head>
    ...
    <title>Quản lý Khuyến mãi Danh mục - Admin</title>
...
<body>
    ...
    <aside class="admin-sidebar">
        ...
        <nav>
            <ul>
                ...
                <li><a href="AdminKhuyenMaiDanhMuc.html" class="active"><i class="fas fa-tag"></i> <span>KM Danh mục</span></a></li>
    ...
    <main class="admin-main">
        <header class="admin-header">
            <h1>Quản lý Khuyến mãi Danh mục</h1>
            <div class="user-info">
        ...
        <div class="admin-content">
            <div class="data-table-container">
                <div class="table-header">
                    <h2><i class="fas fa-tag"></i> Danh sách khuyến mãi danh mục</h2>
    ...
    <div class="modal" id="addModal">
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fas fa-plus-circle"></i> Thêm khuyến mãi danh mục</h3>
                <button class="modal-close" onclick="closeModal('addModal')">&times;</button>
            </div>
            <div class="modal-body">
                <form id="addCategoryDiscountForm">
                    <div class="form-group">
                        <label>Danh mục *</label>
                        <select name="category" required>
                            <option value="">-- Chọn danh mục --</option>
                            <option value="1">Đặc sản miền Bắc</option>
                            <option value="2">Đặc sản miền Trung</option>
                            <option value="3">Đặc sản miền Nam</option>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="saveCategoryDiscount()">
    ...
    <div class="modal" id="editModal">
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fas fa-edit"></i> Sửa khuyến mãi danh mục</h3>
                <button class="modal-close" onclick="closeModal('editModal')">&times;</button>
            </div>
            <div class="modal-body">
                <form id="editCategoryDiscountForm">
                    <div class="form-group">
                        <label>Danh mục *</label>
                        <select name="category" required>
                            <option value="">-- Chọn danh mục --</option>
                            <option value="1" selected>Đặc sản miền Bắc</option>
                            <option value="2">Đặc sản miền Trung</option>
                            <option value="3">Đặc sản miền Nam</option>
                            <option value="4">Bánh</option>
                            <option value="5">Trà</option>
                    ...
                    <div class="form-group">
                        <label>Phần trăm giảm giá (%) *</label>
                        <input type="number" name="discount_percentage" required min="1" max="100" value="15">
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label>Ngày bắt đầu *</label>
                        ...
                        <div class="form-group">
                            <label>Ngày kết thúc *</label>
                            <input type="date" name="end_date" required value="2025-12-15">
                        </div>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" onclick="updateCategoryDiscount()">
