    ...
    <section class="section-bottom">
        <div class="container">
            <nav>
                ...
                <a class="item" href="TinTucBlog.html">Tin tức / blog</a>
            </nav>
        </div>
    </section>
</header>
...
<main>
    <section class="section-tin-tuc">
        <div class="news-container">
            <h2 class="blog-title">Tin tức & Blog mới nhất</h2>
            <div class="blog-grid">
                <article class="blog-card">
                    <img src="https://cdn.tgdd.vn/Files/2020/10/20/1300396/cach-lam-lap-xuong-tuoi-can-duoc-tai-nha-chua-ngot-chuan-vi-202202221426155824.jpg"
                         alt="">
                    <div class="blog-content">
                        <h3>Cách làm lạp xưởng ngon tại nhà</h3>
                        <p>Bật mí công thức làm lạp xưởng truyền thống chuẩn vị miền Tây, không cần máy móc vẫn ngon và
                            bảo quản được lâu.</p>
                        <a href="blog-news-detail.jsp">Đọc thêm</a>
                    </div>
                </article>

                <article class="blog-card">
                    <img src="https://huongvietmart.vn/wp-content/uploads/2022/09/dac-san-Viet-Nam-lam-qua-1.jpg"
                         alt="">
                    <div class="blog-content">
                        <h3>Mẹo chọn đặc sản vùng miền đúng vị</h3>
                        <p>Hướng dẫn cách chọn đặc sản vùng miền uy tín, đảm bảo nguồn gốc và chất lượng khi mua hàng
                            online.</p>
                        <a href="blog-news-detail.jsp">Đọc thêm</a>
                    </div>
                </article>
                ...
                <article class="blog-card">
                    <img src="https://cdn2.fptshop.com.vn/unsafe/750x0/filters:format(webp):quality(75)/Dac_san_mien_Tay_1_c20c915fc2.jpg"
                         alt="">
                    <div class="blog-content">
                        <h3>Khám phá đặc sản miền Tây</h3>
                        <p>Miền Tây không chỉ nổi tiếng với cảnh sông nước hữu tình mà còn là thiên đường của những món
                            ăn khó quên.</p>
                        <a href="blog-news-detail.jsp">Đọc thêm</a>
                    </div>
                </article>
