...
<head>
    ...
    <title>Admin Dashboard - Đặc Sản Vùng Miền</title>
...
<body>
    ...
    <aside class="admin-sidebar">
        ...
        <nav>
            <ul>
                <li><a href="AdminDashboard.html" class="active"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
    ...
    <main class="admin-main">
        ...
        <div class="admin-content">
            ...
            <div class="quick-actions">
                <a href="admin-products.jsp" class="quick-action-card">
                    <i class="fas fa-plus-circle"></i>
                    <p>Thêm sản phẩm</p>
                </a>
                <a href="admin-orders.jsp" class="quick-action-card">
                    <i class="fas fa-clipboard-list"></i>
                    <p>Xem đơn hàng</p>
                </a>
                <a href="admin-discount-vouchers.jsp" class="quick-action-card">
                    <i class="fas fa-ticket-alt"></i>
                    <p>Tạo voucher</p>
                </a>
                <a href="admin-news.jsp" class="quick-action-card">
            ...
            <div class="data-table-container">
                <div class="table-header">
                    ...
                    <a href="admin-orders.jsp" class="btn btn-primary">Xem tất cả</a>
                </div>
                <table class="data-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="actions">
                                <button class="btn btn-info btn-sm" onclick="openModal('detailModal')"><i class="fas fa-eye"></i></button>
                            </td>
                        </tr>
                        <tr>
                            <td>#DH002</td>
    ...
    <div class="modal" id="detailModal">
        <div class="modal-content" style="max-width: 800px;">
            ...
            <div class="modal-footer">
                ...
                <a href="admin-orders.jsp" class="btn btn-primary">
    ...
    <script>
        ...
        new Chart(ctx1, {
            type: 'line',
            data: {
                labels: ['30/11', '01/12', '02/12', '03/12', '04/12', '05/12', '06/12'],
                datasets: [{
                    label: 'Doanh thu (triệu đồng)',
                    data: [2.5, 3.2, 2.8, 4.1, 3.5, 4.8, 5.2],
                    borderColor: '#8bc34a',
        ...
        new Chart(ctx2, {
            type: 'doughnut',
            data: {
                labels: ['Miền Bắc', 'Miền Trung', 'Miền Nam', 'Bánh', 'Trà', 'Khác'],
                datasets: [{
                    data: [25, 30, 20, 10, 8, 7],
                    backgroundColor: [
                        '#667eea',
                        '#11998e',
                        '#f093fb',
